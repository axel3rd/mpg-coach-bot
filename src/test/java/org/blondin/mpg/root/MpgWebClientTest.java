...
public class MpgWebClientTest extends AbstractMockTestClient {
    ...
    protected static void stubStep1(Config config, String url) {
        // --- Step 1: Initiate auth with MPG (POST form) ---
        stubFor(post(urlMatching("/auth?.*")).withQueryParams(Map.of("_data", new ContainsPattern("routes/__home/__auth/auth"))).withFormParam("email", new ContainsPattern(config.getLogin()))
                .withFormParam("password", new ContainsPattern(config.getPassword())).willReturn(aResponse().withStatus(204).withHeader("x-remix-redirect", url
    ...
    protected static void stubStep2() {
    ...
    protected static void stubStep3(Config config) {
    ...
    protected static void stubStep4() {
    ...
    protected static void stubStep5() {
    ...
    protected static void stubStep6() {
    ...
    public void testSinIn() {
        ...
        UserSignIn usi = client.authenticate(config.getLogin(), config.getPassword());
    ...
    public void testBadStep1() {
        ...
        // --- Step 1: Initiate auth with MPG (POST form) ---
        stubFor(post(urlMatching("/auth?.*")).withQueryParams(Map.of("_data", new ContainsPattern("routes/__home/__auth/auth"))).withFormParam("email", new ContainsPattern(config.getLogin()))
                .withFormParam("password", new ContainsPattern(config.getPassword())).willReturn(aResponse().withStatus(204)));
